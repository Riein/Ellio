...
import com.sasha.game.state.LoadState;
import com.sasha.game.state.State;
import com.sasha.framework.util.InputHandler;
...
public class Game extends JPanel implements Runnable{
	...
	public void setCurrentState(State newState){
		...
		inputHandler.setCurrentState(currentState); // This is the new line
	}
	
	@Override
	public void addNotify(){
		super.addNotify();
		initInput(); // This is the new line!
